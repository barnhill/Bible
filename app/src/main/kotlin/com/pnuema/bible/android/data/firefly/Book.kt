...
data class Book(
    ...
    override fun convertToOfflineModel(version: String) = BookOffline(book_id = book_id, title = title, version = version, newTestament = newtestament == 1)
}
